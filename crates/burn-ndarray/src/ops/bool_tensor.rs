...
// Workspace crates
use burn_backend::{Shape, TensorData, backend::BackendTypes};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn bool_device(_tensor: &NdArrayTensor) -> <NdArray<E> as BackendTypes>::Device {
        NdArrayDevice::Cpu
    }

    fn bool_empty(
        shape: Shape,
        _device: &<NdArray<E> as BackendTypes>::Device,
        dtype: BoolDType,
    ) -> NdArrayTensor {
