...
impl<H: Clone> HandleContainer<H> {
    ...
    /// Get the [float tensor](burn_backend::backend::BackendCore::FloatTensorPrimitive) corresponding to the
    ...
    /// Get the [int tensor](burn_backend::backend::BackendCore::IntTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [bool tensor](burn_backend::backend::BackendCore::BoolTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Register a new [float tensor](burn_backend::backend::BackendCore::FloatTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [int tensor](burn_backend::backend::BackendCore::IntTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [bool tensor](burn_backend::backend::BackendCore::BoolTensorPrimitive) with the corresponding [tensor id](TensorId).
